...
Multi-label-classificationis a project for toxic comment classification.(Take kaggle toxic-comment-classification-challenge as our dataset [refere]https://www.kaggle.com/c/jigsaw-toxic-comment-classification-challenge/). In this repository we will expore different model options to solve multi-label problem using static word embedding and contextual word representation in different models.
